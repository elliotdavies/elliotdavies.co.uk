export const title = "Reacting to Google Form submissions with Apps Script"
export const date = "2019-01-06"

# Reacting to Google Form submissions with Apps Script
